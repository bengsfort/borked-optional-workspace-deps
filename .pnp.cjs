...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      {
        "name": "workspace-optionals",
        "reference": "workspace:."
      },
      {
        "name": "main",
        "reference": "workspace:packages/main"
      },
      {
        "name": "optional",
        "reference": "workspace:packages/optional"
      },
      {
        "name": "required",
        "reference": "workspace:packages/required"
      }
    ],
    ...
    "fallbackExclusionList": [
      ...
      ["optional", ["workspace:packages/optional"]],
      ["required", ["workspace:packages/required"]],
      ["workspace-optionals", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    "packageRegistryData": [
      ...
      ["optional", [
        ["workspace:packages/optional", {
          "packageLocation": "./packages/optional/",
          "packageDependencies": [
            ["optional", "workspace:packages/optional"]
          ],
          "linkType": "SOFT",
      ...
      ["required", [
        ["workspace:packages/required", {
          "packageLocation": "./packages/required/",
          "packageDependencies": [
            ["required", "workspace:packages/required"]
          ],
          "linkType": "SOFT",
